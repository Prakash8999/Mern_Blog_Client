...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        {(ref) => (
          <div ref={ref} className={`${isOpen ? 'block' : 'hidden'} md:hidden bg-white w-full absolute`}>
            ...
            <div className="px-2 pt-2 pb-3 sm:px-3">
              ...
              <Link to={"/post"} className="block text-gray-600 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-base font-medium transition duration-300 ease-in-out">My Blogs</Link>
